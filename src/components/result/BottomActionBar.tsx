  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onCheckAll}
        className="flex-1 flex items-center gap-3 min-w-0 rounded-none border-r border-gray-200 py-2 px-4 text-left bg-white hover:bg-gray-50"
      >
      ...
      <button
        ...
        className="flex-1 flex items-center gap-3 min-w-0 rounded-none py-2 px-4 text-left bg-primary hover:bg-primary/90"
      >
